...
def _predict_one_fold(
    ...
    *,
    ...
    from frpn.linear import train as bcdb_main  # type: ignore
    from frpn.linear.models.model import MultiMolModel  # type: ignore
    from frpn.linear.data import build_dataloader  # type: ignore

    ckpt = torch.load(str(ckpt_path), map_location="cpu")
    args_dict = ckpt.get("args", {})

    # Rebuild args object using main.parse_args(), then override with ckpt args.
    # This is safer than constructing a raw Namespace since -m frpn.linear.train expects many fields.
    argv = [
        "prog",
        "--dataset_name",
        "_eval",
