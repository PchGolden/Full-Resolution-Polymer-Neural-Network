...
def parse_args():
    ...
    parser.add_argument("--pretrain_train_path", default="data/pretraining/pretrain_train.lmdb")
    parser.add_argument("--pretrain_val_path",default="data/pretraining/pretrain_val.lmdb")
    ...
    parser.add_argument(
        "--fp_csv",
        default="data/raw/bcdb/bcdb.csv",
