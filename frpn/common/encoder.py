"""Token and pair Transformer shared by the linear and MD models."""
...
from frpn.common.attention import Attention
from .layers import DropPath, OuterProduct, TriangleMultiplication, Transition


class EncoderBlock(nn.Module):
    """Stack encoder layers with token and pair normalization."""
