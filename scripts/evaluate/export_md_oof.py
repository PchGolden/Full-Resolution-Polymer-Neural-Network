...
python -m frpn.cli.export_oof md \
  ...
  --models FRPN --out_dir reproduced/md_oof --cpu
"""
...
# Ensure `src_MD/` is importable (for `models/` and `dataloader/`).
_SRC_MD_DIR = Path(__file__).resolve().parents[2] / 'frpn/pipelines/md_final1640_v2'
sys.path.insert(0, str(_SRC_MD_DIR))

from dataloader.dataloader_polymer import build_dataloader  # noqa: E402
from models.multi_mol_model import MultiMolModel  # noqa: E402
