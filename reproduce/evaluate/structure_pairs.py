...
import argparse
from reproduce.evaluate import md_diagnostics as module
...
def main():
    ...
    parser.add_argument('--raw-csv', default='datasets/raw/md_final1640_v2/final_1640dataset.csv')
    parser.add_argument('--fold-csv', default='datasets/splits/md_final1640_v2/with_fold.csv')
    parser.add_argument('--predictions', default='reproduce/results/oof_predictions/md_final1640_v2')
