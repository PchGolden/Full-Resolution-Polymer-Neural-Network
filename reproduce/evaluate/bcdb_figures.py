...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--meta_csv", default="reproduce/results/oof_predictions/bcdb/sample_meta.csv")
    p.add_argument(
        "--cache6_npz",
        default="../zenodo/figures_source_cache/bcdb/cache_6models_oof_5fold_v1.npz",
        help="Released 6-model OOF prediction/embedding cache from the Zenodo archive",
    )
    p.add_argument("--out_dir", default="reproduce/outputs/analysis/bcdb_figures")
    ...
    p.add_argument(
        "--kimmig_log_glob",
        default="reproduce/outputs/logs/kimmig/KIMMIG_BCDB_5F_*.out",
